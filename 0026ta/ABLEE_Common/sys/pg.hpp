...
public:
	...
	void SetMatchCpeDelay(uint);				//2023.08.15 - KWMOON(0~7cycle)
...
//	CGlobalSet _TPH1A , _TPH2A;						//2023.06.13 - kwmoon(comment fatric)
//	CGlobalSet _TPH1B , _TPH2B;						//2023.06.13 - kwmoon(comment fatric)
//	CGlobalSet _TPH1C , _TPH2C;						//2023.06.13 - kwmoon(comment fatric)
//	CGlobalSet _TPH1D , _TPH2D;						//2023.06.13 - kwmoon(comment fatric)
	CGlobalSet _D1D   ,          _TPH1A , _TPH2A;
	CGlobalSet _D1E   ,          _TPH1B , _TPH2B;
	CGlobalSet _D1F   ,          _TPH1C , _TPH2C;
	CGlobalSet _D1G   ,          _TPH1D , _TPH2D;
	CGlobalSet _D1H   ;
